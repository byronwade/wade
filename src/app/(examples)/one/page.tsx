		...
		<div className="bg-gray-900">
			<main>
						...
						<div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
							...
							<div className="mt-24 sm:mt-32 lg:mt-16">
								<a href="#" className="inline-flex space-x-6">
									<Button color="blue">Latest updates</Button>
									<Button className="p-0" color="transparent" marketing={true}>
										<span>Just shipped v1.0</span>
										<ChevronRightIcon className="ml-3 mt-0.5 h-5 w-5" aria-hidden="true" />
									</Button>
								</a>
							</div>
							<Header className="block mb-4 mt-8" color="black" size="large">Deploy to the cloud with confidence</Header>
							<SubHeading color="gray">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</SubHeading>
				...
				<div className="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8">
					<SubHeading color="black" className="text-center font-bold">The world’s most innovative companies use our app</SubHeading>
				...
				<div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
					<div className="mx-auto max-w-2xl text-center">
						<SubHeading color="blue" className="text-center">Deploy faster</SubHeading>
						<Header color="black" size="medium">Everything you need to deploy your app</Header>
						<SubHeading color="gray" className="text-center">Lorem ipsum dolor sit amet consect adipisicing elit. Possimus magnam voluptatum cupiditate veritatis in accusamus quisquam.</SubHeading>
					</div>
				...
				<div className="mt-32 sm:mt-56">
					<div className="mx-auto max-w-7xl px-6 lg:px-8">
						<div className="mx-auto max-w-2xl sm:text-center">
							<SubHeading color="blue" className="text-center">Everything you need</SubHeading>
							<P className="font-bold">No server? No problem.</P>
							<P color="gray">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis.</P>
						</div>
					</div>
					<div className="relative overflow-hidden pt-16">
						<div className="mx-auto max-w-7xl px-6 lg:px-8">
							<img src="https://tailwindui.com/img/component-images/dark-project-app-screenshot.png" alt="App screenshot" className="mb-[-12%] rounded-xl shadow-2xl ring-1 ring-white/10" width={2432} height={1442} />
				...
				<div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
					<div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
						...
						<p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Trusted by thousands of developers&nbsp;worldwide</p>
				...
				<div className="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
					...
					<div className="mx-auto max-w-2xl text-center">
						...
						<Button color="white" marketing={true}>
							Get Started
						</Button>
							<Button className="p-0" color="transparent" marketing={true}>
							Learn More
			...
			<footer aria-labelledby="footer-heading" className="relative">
				...
				<div className="mx-auto max-w-7xl px-6 pb-8 pt-4 lg:px-8">
					<div className="border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
						...
						<p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">&copy; 2020 Your Company, Inc. All rights reserved.</p>
					</div>
				</div>
			</footer>
		</div>
